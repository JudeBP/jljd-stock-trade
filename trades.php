...
if (isset($_POST['search-btn'])) {
    if (!empty($_POST['search-txt'])) {
        $stocks = $db->searchTrade(clean($_POST['search-txt']));
    } else $stocks = array();
} else $stocks = $db->getTrades();
                ...
                <table class="items-table">
                    ...
                    if (sizeof($stocks) > 0) {
                        foreach ($stocks as $stock) {
                            ...
                            if ($stock['TransactionType'] == 0) {
                                $type = "Buy";
                            } else $type = "Sell";
                            echo "<tr class = 'border-bottom'> 
                            <td>" . $stock['StockName'] . "</td>
                            <td>" . $stock['TradeDate'] . "</td>
                            <td>" . $stock['TradeTime'] . "</td>
                            <td>" . $type . "</td>
                            <td>
                                <a href='order-summary.php?order=$stockID' class='btn btn-white btn-table'> View Order </a> 
                            </td>
                            </tr>";
                        }
                        echo "</table>";
